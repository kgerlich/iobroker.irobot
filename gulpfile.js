...
gulp.task('rename', function ()  {
    ...
    if (!newname) {
        console.log('Please write the new irobot name, like: "gulp rename --name mywidgetset" --author "Author Name"');
        process.exit();
    }
    ...
    if (fs.existsSync(__dirname + '/admin/irobot.png')) {
        fs.renameSync(__dirname + '/admin/irobot.png',              __dirname + '/admin/' + newname + '.png');
    }
    if (fs.existsSync(__dirname + '/widgets/irobot.html')) {
        fs.renameSync(__dirname + '/widgets/irobot.html',           __dirname + '/widgets/' + newname + '.html');
    }
    if (fs.existsSync(__dirname + '/widgets/irobot/js/irobot.js')) {
        fs.renameSync(__dirname + '/widgets/irobot/js/irobot.js', __dirname + '/widgets/irobot/js/' + newname + '.js');
    }
    if (fs.existsSync(__dirname + '/widgets/irobot')) {
        fs.renameSync(__dirname + '/widgets/irobot',                __dirname + '/widgets/' + newname);
    }
    var patterns = [
        {
            match: /irobot/g,
        ...
        {
            match: /irobot/g,
            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'irobot'
        },
        {
